...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinxCollectionsLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>kotlinx.collections.immutable</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class KtlintLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compose</b> with <b>io.nlopez.compose.rules:ktlint</b> coordinates and
         * with version reference <b>ktlint.compose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("ktlint.compose");
        }

        /**
         * Dependency provider for <b>version</b> with <b>com.pinterest.ktlint:ktlint-ruleset-standard</b> coordinates and
         * with version reference <b>ktlint.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getVersion() {
            return create("ktlint.version");
        }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.bom</b> with value <b>2024.03.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>compose.compiler</b> with value <b>1.5.11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class DatastoreVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>datastore.preferences</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>kotlin.ksp</b> with value <b>1.9.23-1.0.19</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.kotlinx.collections</b>
         */
    ...
    public static class KotlinxCollectionsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.collections.immutable</b> with value <b>0.3.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KtlintVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ktlint.compose</b> with value <b>0.3.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompose() { return getVersion("ktlint.compose"); }

        /**
         * Version alias <b>ktlint.plugin</b> with value <b>12.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ktlint.version</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComGoogleDevtoolsPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>kotlin.ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
    ...
    public static class OrgJlleitschuhGradlePluginAccessors extends PluginFactory {
         ...
         * with version reference <b>ktlint.plugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
